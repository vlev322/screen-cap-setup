(function () {
  ...
  var multirange = function (input) {
    ...
    // const _min_input = document.querySelectorAll("input[type=text][min]")[0];
    // const _max_input = document.querySelectorAll("input[type=text][max]")[0];
    ...
    Object.defineProperties(input, {
      valueLow: {
        get: function () {
          const v = Math.min(this.originalValue, ghost.value);
          // _min_input.value = v;
          return v;
        },
        set: function (v) {
      ...
      valueHigh: {
        get: function () {
          const v = Math.max(this.originalValue, ghost.value);
          // _max_input.value = v;
          return v;
        },
        set: function (v) {
    ...
    // _min_input.oninput = () => {
    //   const _value = _min_input.value;
    //   input.valueLow = _value;
    // };
    // _max_input.oninput = () => {
    //   const _value = _max_input.value;
    //   input.valueHigh = _value;
    // };
    if (descriptor.get) {
